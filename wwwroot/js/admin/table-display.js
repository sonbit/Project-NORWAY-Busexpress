...
function displayTickets(index) {
    var output = 
        "<table class='table table-striped table-bordered table-dark table-sm table-responsive-md'>" +
        "<thead><tr>" +
...
function addIcon(index) {
    var output =
        "<div id='add*" + tableIds[index] + "' class='add-tooltip' onclick='editRow(this.id)'><svg id='add-icon' viewBox='0 0 16 16' class='bi bi-plus-square' fill='currentColor' xmlns='http://www.w3.org/2000/svg'>" +
...
function editIcon(tableAndPrimaryKey) {
    var output =
        "<div id='edit*" + tableAndPrimaryKey + "' class='edit-tooltip' onclick='editRow(this.id)'><svg id='edit-icon' viewBox='0 0 16 16' class='bi bi-pencil-square' fill='currentColor' xmlns='http://www.w3.org/2000/svg'>" +
